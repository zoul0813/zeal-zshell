...
var ASM_CONSTS = {
  317800: () => { if (document.fullscreenElement) return 1; },  
 317846: () => { return Module.canvas.width; },  
 317878: () => { return parseInt(Module.canvas.style.width); },  
 317926: () => { document.exitFullscreen(); },  
 317953: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 318026: () => { if (document.fullscreenElement) return 1; },  
 318072: () => { return Module.canvas.width; },  
 318104: () => { return screen.width; },  
 318129: () => { document.exitFullscreen(); },  
 318156: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 318289: () => { return window.innerWidth; },  
 318315: () => { return window.innerHeight; },  
 318342: () => { if (document.fullscreenElement) return 1; },  
 318388: () => { return Module.canvas.width; },  
 318420: () => { return parseInt(Module.canvas.style.width); },  
 318468: () => { if (document.fullscreenElement) return 1; },  
 318514: () => { return Module.canvas.width; },  
 318546: () => { return screen.width; },  
 318571: () => { return window.innerWidth; },  
 318597: () => { return window.innerHeight; },  
 318624: () => { if (document.fullscreenElement) return 1; },  
 318670: () => { return Module.canvas.width; },  
 318702: () => { return screen.width; },  
 318727: () => { document.exitFullscreen(); },  
 318754: () => { if (document.fullscreenElement) return 1; },  
 318800: () => { return Module.canvas.width; },  
 318832: () => { return parseInt(Module.canvas.style.width); },  
 318880: () => { document.exitFullscreen(); },  
 318907: ($0) => { Module.canvas.style.opacity = $0; },  
 318945: () => { return screen.width; },  
 318970: () => { return screen.height; },  
 318996: () => { return window.screenX; },  
 319023: () => { return window.screenY; },  
 319050: () => { return window.devicePixelRatio; },  
 319086: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 319139: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 319190: () => { Module.canvas.style.cursor = 'none'; },  
 319227: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 319483: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 319534: () => { if (document.fullscreenElement) return 1; },  
 319580: () => { return window.innerWidth; },  
 319606: () => { return window.innerHeight; },  
 319633: () => { if (document.pointerLockElement) return 1; },  
...
var _show_fps = Module['_show_fps'] = 1278979;var wasmImports = {
  /** @export */
  GetCanvasIdJs,
  /** @export */
