...
set(GENERATE_DEFCONFIG_SCRIPT "${CMAKE_SOURCE_DIR}/scripts/generate_defconfig.py")
...
add_custom_command(
    ...
    COMMAND ${Python3_EXECUTABLE} ${GENERATE_DEFCONFIG_SCRIPT}
        ${CMAKE_SOURCE_DIR}/Kconfig ${KCONFIG_CONFIG}
    DEPENDS ${CMAKE_SOURCE_DIR}/Kconfig ${GENERATE_DEFCONFIG_SCRIPT}
