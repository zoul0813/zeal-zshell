...
add_custom_command(
    ...
    COMMAND ${CMAKE_COMMAND} -E echo "CONFIG_BATCH_MAX_DEPTH=4" >> ${KCONFIG_CONFIG}
    ...
    COMMAND ${CMAKE_COMMAND} -E echo "CONFIG_BUILTIN_HASH=y" >> ${KCONFIG_CONFIG}
    COMMAND ${CMAKE_COMMAND} -E echo "CONFIG_BUILTIN_PWD=y" >> ${KCONFIG_CONFIG}
    COMMAND ${CMAKE_COMMAND} -E echo "CONFIG_BUILTIN_EXIT=y" >> ${KCONFIG_CONFIG}
    COMMAND ${CMAKE_COMMAND} -E echo "CONFIG_BUILTIN_EXEC=y" >> ${KCONFIG_CONFIG}
    COMMAND ${CMAKE_COMMAND} -E echo "CONFIG_BUILTIN_CLEAR=y" >> ${KCONFIG_CONFIG}
    COMMAND ${CMAKE_COMMAND} -E echo "CONFIG_BUILTIN_WHICH=y" >> ${KCONFIG_CONFIG}
    COMMAND ${CMAKE_COMMAND} -E echo "CONFIG_BUILTIN_TRUE=y" >> ${KCONFIG_CONFIG}
    COMMAND ${CMAKE_COMMAND} -E echo "CONFIG_BUILTIN_FALSE=y" >> ${KCONFIG_CONFIG}
    COMMAND ${CMAKE_COMMAND} -E echo "CONFIG_BUILTIN_VER=y" >> ${KCONFIG_CONFIG}
    COMMAND ${CMAKE_COMMAND} -E echo "CONFIG_BUILTIN_RESET=y" >> ${KCONFIG_CONFIG}
